...
<th>Modificar</th>
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo"<td>"."<p> <a href='http://localhost/Basedatos/consulta9.php?ID_sucursal=".$row['ID_sucursal']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='http://localhost/Basedatos/modificar9.php?ID_sucursal=".$row['ID_sucursal']."'>
