...
$sql = "SELECT id_servicio, numero_servicio, tipo, costos, cliente FROM servicios WHERE id_servicio >=0";
 ...
 <div id="header">
  <ul class="nav">
    ...
    <div class="table-container">
      ...
      <i class="material-icons"><a href="alta4.html"><img src="agregar.png" width="40" height="40"></a></i>
        </button>
      </div>
  <table border="1">
<tr>
...
<th>Modificar</th>
  ...
  <?php
    ...
    {
       $recuperada=$_REQUEST['id_servicio'];
      //echo$recuperada;
  
  
      $sql = "DELETE FROM servicios WHERE id_servicio=".$recuperada;
      if($recuperada){
  ...
  while($row = mysqli_fetch_assoc($result)) {
    echo"<tr>";
    echo"<td>". $row["id_servicio"]."</td>". "<td>" . $row["numero_servicio"]."</td>"."<td>". $row["tipo"]."</td>"."<td>" . $row["costos"]."</td>"."<td>". $row["cliente"];
    echo"<td>"."<p> <a href='http://localhost/Basedatos/consulta8.php?id_servicio=".$row['id_servicio']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='http://localhost/Basedatos/modificar8.php?id_servicio=".$row['id_servicio']."'>
