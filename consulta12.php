...
$sql = "SELECT id_usuario, nombre_usuario, telefono, dirección FROM usuarios WHERE id_usuario >=1";
...
if (mysqli_num_rows($result) > 0) {
 ...
 <div id="header">
  <ul class="nav">
    ...
    <i class="material-icons"><a href="alta12.html"><img src="agregar.png" width="40" height="40"></a></i>
      <div class="tools">
...
<th>Modificar</th>
  ...
  <?php
    ...
    {
       $recuperada=$_REQUEST['id_usuario'];
      //echo$recuperada;
  
  
      $sql = "DELETE FROM usuarios WHERE id_usuario=".$recuperada;
      if($recuperada){
 ...
 echo"<tr>";
    echo"<td>". $row["id_usuario"]."</td>". "<td>" . $row["nombre_usuario"]."</td>"."<td>". $row["telefono"]."</td>"."<td>" . $row["dirección"];
    echo"<td>"."<p> <a href='http://localhost/Basedatos/consulta12.php?id_usuario=".$row['id_usuario']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='http://localhost/Basedatos/modificar12.php?id_usuario=".$row['id_usuario']."'>
