...
$sql = "SELECT id_empleado, nombre_empleado, salario, dirección FROM empleados WHERE id_empleado >=1";
...
if (mysqli_num_rows($result) > 0) {
 ...
 <div id="header">
  <ul class="nav">
    ...
    <li><a href="consulta3.php">Consulta Servicios</a></li>
    <li><a href="consulta4.php">Consulta Consulta</a></li>
    <li><a href="consulta5.php">Consulta Compras</a></li>
    <li><a href="consulta6.php">Consulta Empleado</a></li>
    <li><a href="consulta7.php">Consulta Proovedor</a></li>
    ...
    <div class="table-container">
      ...
      <i class="material-icons"><a href="Alta2.html"><img src="agregar.png" width="40" height="40"></a></i>
        </button>
      </div>
  <table border="1">
<tr>
...
<?php
  ...
  while($row = mysqli_fetch_assoc($result)) {
    echo"<tr>";
    echo"<td>". $row["id_empleado"]."</td>". "<td>" . $row["nombre_empleado"]."</td>"."<td>". $row["salario"]."</td>"."<td>" . $row["dirección"];
    echo"<td>"."<p> <a href='http://localhost/Basedatos/consulta5.php?id_empleado=".$row['id_empleado']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='http://localhost/Basedatos/modificar5.php?id_empleado=".$row['id_empleado']."'>
