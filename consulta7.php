...
$sql = "SELECT id_proveedor, Nombre_proveedor, telefono, dirección FROM proveedores WHERE id_proveedor >=1";
 ...
 <div id="header">
  <ul class="nav">
    ...
    <div class="table-container">
      ...
      <i class="material-icons"><a href="alta8.html"><img src="agregar.png" width="40" height="40"></a></i>
        </button>
      </div>
  <table border="1">
<tr>
...
<th>Modificar</th>
  ...
  <?php
    ...
    {
       $recuperada=$_REQUEST['id_proveedor'];
      //echo$recuperada;
  
  
      $sql = "DELETE FROM proveedores WHERE id_proveedor=".$recuperada;
      if($recuperada){
  ...
  while($row = mysqli_fetch_assoc($result)) {
    echo"<tr>";
    echo"<td>". $row["id_proveedor"]."</td>". "<td>" . $row["Nombre_proveedor"]."</td>"."<td>". $row["telefono"]."</td>"."<td>" . $row["dirección"];
    echo"<td>"."<p> <a href='http://localhost/Basedatos/consulta7.php?id_proveedor=".$row['id_proveedor']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='http://localhost/Basedatos/modificar7.php?id_proveedor=".$row['id_proveedor']."'>
