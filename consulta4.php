...
$sql = "SELECT id_contactos, nombre_contactos, telefono, dirección FROM contactos WHERE id_contactos >=1";
...
if (mysqli_num_rows($result) > 0) {
 ...
 <div id="header">
  <ul class="nav">
    ...
    <li><a href="consulta3.php">Consulta Consulta</a></li>
    <li><a href="consulta4.php">Consulta Compras</a></li>
    ...
    <div class="table-container">
      ...
      <i class="material-icons"><a href="alta6.html"><img src="agregar.png" width="40" height="40"></a></i>
        </button>
      </div>
  <table border="1">
<tr>
...
<th>Modificar</th>
  ...
  <?php
    ...
    {
       $recuperada=$_REQUEST['id_contactos'];
      //echo$recuperada;
  
  
      $sql = "DELETE FROM contactos WHERE id_contactos=".$recuperada;
      if($recuperada){
  ...
  while($row = mysqli_fetch_assoc($result)) {
    echo"<tr>";
    echo"<td>". $row["id_contactos"]."</td>". "<td>" . $row["nombre_contactos"]."</td>"."<td>". $row["telefono"]."</td>"."<td>" . $row["dirección"];
    echo"<td>"."<p> <a href='http://localhost/Basedatos/consulta4.php?id_contactos=".$row['id_contactos']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='http://localhost/Basedatos/modificar4.php?id_contactos=".$row['id_contactos']."'>
